...
public class Home extends Show {
	...
	private void switchMode() {
		for (String student : AdminUI.roster) {
			teacher.sendChatMessage("/gamemode " + (areStudentsInCreative ? "0 " : "1 ") + student.split("-")[0]);
		}
	...
	public void setup() {
		...
		numberOfStudentsOnRoster = new TextLabel((int)(width * .37), (int)(height * .4), 90, 20, AdminUI.roster.size() + "/" + "Total", TextAlignment.LEFT);
